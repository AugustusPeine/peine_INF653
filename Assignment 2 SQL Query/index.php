...
$query = $query = 'SELECT customers.customerID, customers.emailAddress, customers.firstName, customers.lastName,
                    ...
                    addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone';
                    //Select user info and address info from customers and addresses tables
                    //Joining them on customerID
                    //Then group by all selected fields
